import { ELEMENT_TYPE, FRAGMENT_TYPE, TEXT_TYPE } from "shared/Symbols";
...
const translateTextNodes = (child) =>
    typeof child === "object"
        ? child
        : ReactElement(TEXT_TYPE, null, {
              nodeValue: child,
              children: [],
          });
...
export function createElement(type, config, ...children) {
    ...
    if (childrenLength === 1) {
        props.children = children.map(translateTextNodes);
    } else {
        // Allocate an Array
        ...
        props.children = childArray.map(translateTextNodes);
    }
...
export { FRAGMENT_TYPE as Fragment, jsx, jsx as jsxs };
